...
public class NearByActivityRvAdapter extends RecyclerView.Adapter<NearByActivityRvAdapter.MyViewHolder>{
    ...
    public NearByActivityRvAdapter(Context mContext, ArrayList<Activity> mData) {
        ...
        public MyViewHolder(@NonNull final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(listener != null){
                            listener.onNearByActivityObjectClicked(getAdapterPosition(), v);
                    }
                }
            });
